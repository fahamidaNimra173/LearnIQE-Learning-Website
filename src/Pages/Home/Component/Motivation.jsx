...
<section className="lg:mt-40 mt-20 mb-30">
  <h1 className=" text-center uppercase md:text-4xl lg:text-6xl  text-2xl font-mono my-8 font-bold text-[#fbbc2c]">
    Stay <span className="text-[rgb(238,243,242)]">Inspired</span>, Stay <span className="text-[#f6f9f8]">Strong</span>
  </h1>
