...
const AboutUs = () => {
  return (
    <div className="bg-gray-50 text-gray-900">
      {/* Banner */}
      <div className="relative h-[300px] flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 space-y-16">
        ...
        {/* Impact in Numbers */}
        <section className="bg-purple-100 p-10 rounded-xl text-center">
          <h2 className="text-3xl font-bold text-purple-700 mb-8">
            Impact in Numbers
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <h3 className="text-4xl font-bold text-purple-900">10K+</h3>
              <p className="text-gray-700">Active Students</p>
            </div>
            <div>
              <h3 className="text-4xl font-bold text-purple-900">200+</h3>
        ...
        <section className="text-center space-y-4">
          ...
          <button className="mt-4 px-6 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition">
            Explore Instructors
          </button>
        </section>
        ...
        {/* Call to Action */}
        <section className="text-center py-12 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl">
